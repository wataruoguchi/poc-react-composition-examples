/**
 * This example shows how to use dependency injection to pass a component as a prop.
...
export function ExampleWithDependencyInjection({ color }: ExampleProps) {
...
function Box({ color }: { color: string }) {
  return (
    <div style={{ width: "100px", height: "100px", backgroundColor: color }}>
      The color is {color} in ExampleWithDependencyInjection
    </div>
  );
}
